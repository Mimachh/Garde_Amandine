  ...
  <div class="bg-perso -mt-2 py-3">
    <div>
        ...
        <div x-show="open" id="filterDiv" class="fixed inset-0 z-40 flex">
          <!--
            ...
            Leaving: "transition ease-in-out duration-300 transform"
              ...
              To: "translate-x-full"
          -->
          <div class="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-10 shadow-xl">
            ...
            <form action="{{ route('annonces.search') }}" id="searchForm" class="mt-4 border-t border-gray-200">
              ...
              <div class="px-4 py-6">
                ...
                <div class="">
                    <input value="{{ request()->departementCode ?? '' }}" class="w-full border-none bg-gray-200 rounded-xl" placeholder="Entrer un numero de département"
      ...
      <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex items-baseline justify-between pt-4 pb-4">
          ...
          <div @click.away="open = false" x-data="{ open: false }" class="flex items-center">
            ...
            <button value="Show Div" onclick="showDiv()"  type="button" class="items-center space-x-2 flex -m-2 ml-4 text-gray-400 hover:text-gray-500 sm:ml-6 pb-4">
              <!-- Heroicon name: mini/funnel -->
              <svg class="h-4 w-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
