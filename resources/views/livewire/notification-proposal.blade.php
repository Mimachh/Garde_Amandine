...
<div class="text-center mb-1">            
        ...
        @foreach($notifications as $notification)
            <x-jet-dropdown-link class="mt-2 px-2 hover:bg-red-900 font-normal rounded-lg mb-1" wire:click="marked" href="{{ route('proposals.show', $notification->data['proposal_id']) }}" style="color: #cbd5e0">
