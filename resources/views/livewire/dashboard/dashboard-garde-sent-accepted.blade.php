<div>
    <h2 class="pl-5 md:inline text-gray-600 font-bold text-md"> Mes gardes envoyées acceptées</h2> 
    @forelse($gardeAccepted as $proposal)
    ...
    @empty
        <p class="text-sm font-semi-bold text-gray-600 mb-2 text-center">Aucune demande acceptée à afficher</p>                                                                                                          
    @endforelse
    <div class="mx-4 pb-4">
        {{ $gardeAccepted->withQueryString()->links()}}
    </div>
</div>
