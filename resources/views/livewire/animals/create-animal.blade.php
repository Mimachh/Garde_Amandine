                    ...
                    <div class="overflow-hidden shadow sm:rounded-md mb-10 ">
                        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                            ...
                            <div>
                                ...
                                <textarea wire:model="personnalité" name="personnality" type="text"  class="rounded mt-2 block w-full"  placeholder="Décrivez en quelques mots votre animal pour informer le pet-sitter"></textarea>
                            </div>
